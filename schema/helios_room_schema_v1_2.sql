...
VALUES (
    1,
    '1.2',
    'Helios Room schema v1.2: deterministic message ordering, scoped foreign keys, separate seeded and room memory, memory provenance and supersession, hierarchical topic keys, creator versus owner memory provenance, normalized tool invocations, security-redactable raw API events, FTS5 search, and intentionally relaxed membership/operational enforcement.'
);
